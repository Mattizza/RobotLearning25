...
def parse_args(args=sys.argv[1:]):
    ...
    parser.add_argument("--reward_type", type=float, default=None,
...
def trainer(fargs):
    ...
    training_history = train(agent, env, args.train_episodes, args.reward_type,
                             silent=True, train_run_id=trainer_id, early_stop=False, random_policy=args.random_policy)
